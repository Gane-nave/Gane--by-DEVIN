...
impl SystemMetrics {
    ...
    pub fn register(registry: &MetricRegistry) -> Self {
        let build_info = registry.gauge("gane_build_info", "Build information (always 1)");
        build_info.set(1);
