...
use gane_orchestrator::ServiceRegistry;
use gane_sensors::imu::ImuProcessor;
...
impl NavigationPipeline {
    ...
    pub fn service_stats(&self) -> gane_orchestrator::services::RegistryStats {
...
mod tests {
    ...
    fn pipeline_telemetry_buffer_matches_config() {
        let cfg = gane_config::ConfigBuilder::new()
