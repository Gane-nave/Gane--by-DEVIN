    ...
    pub fn register_defaults(&mut self) {
        let defaults = vec![
            AlertRule {
                ...
                metric_name: "gane_http_error_rate".to_string(),
            ...
            AlertRule {
                ...
                metric_name: "gane_http_latency_p99".to_string(),
                operator: Operator::GreaterThan,
                threshold: 0.5,
            ...
            AlertRule {
                ...
                metric_name: "gane_gnss_tracked_satellites".to_string(),
            ...
            AlertRule {
                ...
                metric_name: "gane_integrity_score".to_string(),
                operator: Operator::LessThan,
                threshold: 0.8,
                severity: Severity::Critical,
